package com.bptn.course._01_big_coding._oct_11._phone_number_prefix;
...
public class PhoneNumberPrefix {
	...
	public static void main(String[] args) {
       ...
       for (int i = 0; i < phoneNumbers.size(); i++) {  // Extract the first seven characters as the prefix
    	   String prefix = phoneNumbers.get(i).substring(0, 7);
