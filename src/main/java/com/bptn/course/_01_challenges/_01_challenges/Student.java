...
public class Student {
       ...
       // Given a list of students, find by id a student that matches the id of the given student and replace it with the given student.
    	for (int i = 0; i < universityStudents.size(); i++) {
            if (universityStudents.get(i).getStudentId() == student.getStudentId()) {
                universityStudents.set(i, student);  // Replace the student
                return;  // Exit the method once replacement is done
            }
        }
    ...
    /*Following the SOLID framework, this will be be better placed in a different class. 
    This will allow the Student Class to have single responsibility.
    */
    }
 // ToString method
    @Override
